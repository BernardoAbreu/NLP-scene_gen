...
for SCENE in $INPUT_DIR*; do
	...
	echo $MOVIE;
	cat "all_scenes/regular/test_sentences/${MOVIE}" >> net_data/test_movies_sentences.txt;
	cat "all_scenes/regular/test_tags/${MOVIE}_tags" >> net_data/test_movies_tags.txt;
	cat "all_scenes/no_punct/test_sentences/${MOVIE}_np" >> net_data/test_movies_sentences_np.txt;
	cat "all_scenes/no_punct/test_tags/${MOVIE}_tags_np" >> net_data/test_movies_tags_np.txt;
	cat "all_scenes/no_stop/test_sentences/${MOVIE}_ns" >> net_data/test_movies_sentences_ns.txt;
